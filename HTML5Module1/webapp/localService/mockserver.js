...
sap.ui.define([
    ...
    function (MockServer, JSONModel, UriParameters, Log) {
        ...
        var oMockServer,
            _sAppPath = "ns_logaligroup/HTML5Module1/",
                ...
                return new Promise(function (fnResolve, fnReject) {
                    ...
                    oManifestModel.attachRequestCompleted(function () {
                        ...
                        oMockServer.simulate(sMetadataUrl, {
                            sMocodataBaseUrk : _sJsonFilesUrl,
                            bGenerateMissingMockData : true
                        });
                        
                        var aRequests = oMockServer.getRequests();

                        //compose an error responce for each request
                        var fResponse = function (iErrorCode, sMessage, aRequest) {
                        ...
                        var iErrorCode = sErrorParam === "barRequest" ? 400 : 500;
